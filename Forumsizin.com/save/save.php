...
if ($result_user->num_rows === 1) {
  ...
  $user_id = $row_user['kullanici_id'];
} else {
  die("Kullanıcı bulunamadı. E-posta: " . htmlspecialchars($user_email));
}
...
SELECT 
    ...
    kat.kategori_adi
FROM kaydetme kay
JOIN kullanici_kaydetme kk ON kay.kaydetme_id = kk.kaydetme_id
JOIN fotograf_kaydetme fk ON kay.kaydetme_id = fk.kaydetme_id
JOIN fotograf f ON fk.fotograf_id = f.fotograf_id
...
ORDER BY kay.kaydetme_tarihi DESC";
